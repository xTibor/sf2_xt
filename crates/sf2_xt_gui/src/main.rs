                        ...
                        if !soundfont_tools.is_empty() {
                            add_section(ui, "SoundFont tools", true, |ui| {
                                ...
                                pub const SOUNDFONT_TOOLS_URLS: &[(&str, &str)] = &[
                                    ...
                                    (
                                        "GigaStudio",
                                        "https://web.archive.org/web/20180817184554/http://tascam.com/product/gigastudio_4/",
                                    ),
                                    (
                                        "Audio Compositor",
                                        "https://web.archive.org/web/20040131094242/http://audiocompositor.home.att.net:80/",
                                    ),
                                    (
                                        "Smurf Sound Font Editor",
                                        "https://sourceforge.net/projects/smurf/",
                                    ),
                                    //(
                                    //    "SFEDT",
                                    //    "???"
